...
func JSONDBUpdate(w http.ResponseWriter, r *http.Request) {
	...
	if storage.ServerFlags.DataBaseDsn != "" && len(*response) > 0 {
	...
	http.Error(w, "db is not exist", http.StatusBadRequest)
